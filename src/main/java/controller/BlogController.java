...
public class BlogController {
    ...
    @RequestMapping(value = "/create_blog", method = RequestMethod.GET)
    ...
    @RequestMapping(value = "/create_blog", method = RequestMethod.POST)
    ...
    @RequestMapping(value = "/edit_blog/{id}", method = RequestMethod.GET)
    ...
    @RequestMapping(value = "/delete_blog/{id}", method = RequestMethod.GET)
    ...
    @RequestMapping(value = "/view_blog/{id}", method = RequestMethod.GET)
